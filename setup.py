...
plugin_identifier = "revoheight"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_revoheight"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Revo Height Manager"
...
# module
plugin_description = """Lets you swap between different nozzle heights in the UI"""
...
plugin_url = "https://github.com/mechanical-girl/revoheightmanager"
